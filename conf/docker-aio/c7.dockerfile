...
RUN cp -r /opt/solr-7.3.0/server/solr/configsets/_default /opt/solr-7.3.0/server/solr/core1
RUN cp /tmp/dv/schema.xml /opt/solr-7.3.0/server/solr/core1/conf/schema.xml
RUN cp /tmp/dv/solrconfig.xml /opt/solr-7.3.0/server/solr/core1/conf/solrconfig.xml
